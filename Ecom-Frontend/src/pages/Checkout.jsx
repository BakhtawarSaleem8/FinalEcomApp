...
import { fetchLoggedInUserAsync, updateUserAsync } from '../features/user/userSlice';
...
const handleOrder = async (e) => {
  ...
  console.log("handleorder clicked")
  // Validate address
  if (!selectedAddress) {
    console.log("inside selected address")
  ...
  try {
    ...
    if (createOrderAsync.fulfilled.match(resultAction)) {
      ...
      // Redirect to order success page with order ID in URL
...
// navigate(`/stripe-checkout/`)
      ...
      throw new Error(resultAction.error.message || 'Failed to create order');
    }
  } catch (error) {
    ...
    // Optional: Redirect to order failure page if you have one
    // navigate('/order-failed');
  }
};
console.log(currentOrder?.paymentMethod , "payment method")
            ...
            <div className="mx-auto mt-12 bg-white max-w-7xl px-2 sm:px-2 lg:px-4">
              ...
              <div className="border-t border-gray-200 px-2 py-6 sm:px-2">
                ...
                <div className="flex justify-between my-2 text-base font-medium text-gray-900">
                  ...
                  <p>{totalItems && totalItems} items</p>
                </div>
